...
Set an optional l tag whenever metadata changes (and on the first event of each dataset). This allows to retrieve a smaller set of events for each dataset to filter for a specific dataset hash.
